...
int REF10_crypto_hashblocks_sha512(unsigned char *statebytes,const unsigned char *in,unsigned long long inlen)
{
  ...
  while (inlen >= 128) {
    ...
    REF10_F(w2 ,0xb5c0fbcfec4d3b2fULL)
    REF10_F(w3 ,0xe9b5dba58189dbbcULL)
    REF10_F(w4 ,0x3956c25bf348b538ULL)
    REF10_F(w5 ,0x59f111f1b605d019ULL)
    REF10_F(w6 ,0x923f82a4af194f9bULL)
    REF10_F(w7 ,0xab1c5ed5da6d8118ULL)
    REF10_F(w8 ,0xd807aa98a3030242ULL)
    REF10_F(w9 ,0x12835b0145706fbeULL)
    REF10_F(w10,0x243185be4ee4b28cULL)
    REF10_F(w11,0x550c7dc3d5ffb4e2ULL)
    REF10_F(w12,0x72be5d74f27b896fULL)
    REF10_F(w13,0x80deb1fe3b1696b1ULL)
    REF10_F(w14,0x9bdc06a725c71235ULL)
    REF10_F(w15,0xc19bf174cf692694ULL)

    REF10_EXPAND

    REF10_F(w0 ,0xe49b69c19ef14ad2ULL)
    REF10_F(w1 ,0xefbe4786384f25e3ULL)
    REF10_F(w2 ,0x0fc19dc68b8cd5b5ULL)
    REF10_F(w3 ,0x240ca1cc77ac9c65ULL)
    REF10_F(w4 ,0x2de92c6f592b0275ULL)
    REF10_F(w5 ,0x4a7484aa6ea6e483ULL)
    REF10_F(w6 ,0x5cb0a9dcbd41fbd4ULL)
    REF10_F(w7 ,0x76f988da831153b5ULL)
    REF10_F(w8 ,0x983e5152ee66dfabULL)
    REF10_F(w9 ,0xa831c66d2db43210ULL)
    REF10_F(w10,0xb00327c898fb213fULL)
    REF10_F(w11,0xbf597fc7beef0ee4ULL)
    REF10_F(w12,0xc6e00bf33da88fc2ULL)
    REF10_F(w13,0xd5a79147930aa725ULL)
    REF10_F(w14,0x06ca6351e003826fULL)
    REF10_F(w15,0x142929670a0e6e70ULL)

    REF10_EXPAND

    REF10_F(w0 ,0x27b70a8546d22ffcULL)
    REF10_F(w1 ,0x2e1b21385c26c926ULL)
    REF10_F(w2 ,0x4d2c6dfc5ac42aedULL)
    REF10_F(w3 ,0x53380d139d95b3dfULL)
    REF10_F(w4 ,0x650a73548baf63deULL)
    REF10_F(w5 ,0x766a0abb3c77b2a8ULL)
    REF10_F(w6 ,0x81c2c92e47edaee6ULL)
    REF10_F(w7 ,0x92722c851482353bULL)
    REF10_F(w8 ,0xa2bfe8a14cf10364ULL)
    REF10_F(w9 ,0xa81a664bbc423001ULL)
    REF10_F(w10,0xc24b8b70d0f89791ULL)
    REF10_F(w11,0xc76c51a30654be30ULL)
    REF10_F(w12,0xd192e819d6ef5218ULL)
    REF10_F(w13,0xd69906245565a910ULL)
    REF10_F(w14,0xf40e35855771202aULL)
    REF10_F(w15,0x106aa07032bbd1b8ULL)

    REF10_EXPAND

    REF10_F(w0 ,0x19a4c116b8d2d0c8ULL)
    REF10_F(w1 ,0x1e376c085141ab53ULL)
    REF10_F(w2 ,0x2748774cdf8eeb99ULL)
    REF10_F(w3 ,0x34b0bcb5e19b48a8ULL)
    REF10_F(w4 ,0x391c0cb3c5c95a63ULL)
    REF10_F(w5 ,0x4ed8aa4ae3418acbULL)
    REF10_F(w6 ,0x5b9cca4f7763e373ULL)
    REF10_F(w7 ,0x682e6ff3d6b2b8a3ULL)
    REF10_F(w8 ,0x748f82ee5defb2fcULL)
    REF10_F(w9 ,0x78a5636f43172f60ULL)
    REF10_F(w10,0x84c87814a1f0ab72ULL)
    REF10_F(w11,0x8cc702081a6439ecULL)
    REF10_F(w12,0x90befffa23631e28ULL)
    REF10_F(w13,0xa4506cebde82bde9ULL)
    REF10_F(w14,0xbef9a3f7b2c67915ULL)
    REF10_F(w15,0xc67178f2e372532bULL)

    REF10_EXPAND

    REF10_F(w0 ,0xca273eceea26619cULL)
    REF10_F(w1 ,0xd186b8c721c0c207ULL)
    REF10_F(w2 ,0xeada7dd6cde0eb1eULL)
    REF10_F(w3 ,0xf57d4f7fee6ed178ULL)
    REF10_F(w4 ,0x06f067aa72176fbaULL)
    REF10_F(w5 ,0x0a637dc5a2c898a6ULL)
    REF10_F(w6 ,0x113f9804bef90daeULL)
    REF10_F(w7 ,0x1b710b35131c471bULL)
    REF10_F(w8 ,0x28db77f523047d84ULL)
    REF10_F(w9 ,0x32caab7b40c72493ULL)
    REF10_F(w10,0x3c9ebe0a15c9bebcULL)
    REF10_F(w11,0x431d67c49c100d4cULL)
    REF10_F(w12,0x4cc5d4becb3e42b6ULL)
    REF10_F(w13,0x597f299cfc657e2aULL)
    REF10_F(w14,0x5fcb6fab3ad6faecULL)
    REF10_F(w15,0x6c44198c4a475817ULL)
